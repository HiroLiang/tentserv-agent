...
| `experimental` | `POST /v1/models/{reference}/capabilities`, `GET /v1/models/{reference}/capabilities/proofs`, `DELETE /v1/models/{reference}/capabilities/proofs/{capability}`, `POST /v1/models/{reference}/capabilities/verify` | Public support-status and proof operations. Retry and stale-state recovery behavior is covered by the support-proof hardening slice. |
...
| `experimental` | `tentgent model capability proofs`, `model capability verify`, `model capability proof clear` | Public support-proof commands. Retry and stale-state recovery behavior is covered by the support-proof hardening slice. |
