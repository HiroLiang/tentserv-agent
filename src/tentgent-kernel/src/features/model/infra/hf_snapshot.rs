...
/// Runs the managed Python Hugging Face snapshot helper.
#[derive(Debug, Clone, Copy, Default)]
pub struct StdHfModelSnapshotFetcher;

impl HfModelSnapshotFetcher for StdHfModelSnapshotFetcher {
...
fn parse_hf_progress_line(line: &str) -> Option<HfModelPullProgress> {
