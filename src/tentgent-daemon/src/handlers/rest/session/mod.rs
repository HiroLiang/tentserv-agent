...
use tentgent_kernel::{
    features::session::{
        domain::SessionRefSelector,
        usecases::{
            SessionCatalogReadUseCase, SessionInspectRequest, SessionListRequest,
            SessionMessagesRequest, SessionStoreSelection,
        },
    },
...
use self::dto::{
    session_inspection_item, session_messages_item, session_summary_item, SessionMessagesResponse,
