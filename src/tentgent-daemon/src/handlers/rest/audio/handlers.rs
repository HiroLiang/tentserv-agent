...
mod upload;
use upload::*;
pub use upload::{AudioTranscriptionJobRequest, AudioTranscriptionResultQuery};
...
pub(in crate::handlers::rest) fn optional_trimmed_string(value: Option<String>) -> Option<String> {
...
pub(in crate::handlers::rest) fn model_selector(
    state: &RestState,
    value: &str,
) -> Result<ModelRefSelector, RestError> {
...
pub(in crate::handlers::rest) fn bytes_response(
    bytes: Vec<u8>,
    media_type: &str,
    filename: &str,
    next_cursor: u64,
