...
use super::{
    AdapterKernelComponent, AuthKernelComponent, CapabilityKernelComponent, ClusterKernelComponent,
    DatasetKernelComponent, DoctorKernelComponent, ModelKernelComponent, RuntimeKernelComponent,
    RuntimeOwnershipKernelComponent, ServerKernelComponent, SessionKernelComponent,
    TrainKernelComponent,
};
...
pub struct KernelComponents {
    ...
    runtime_ownership: RuntimeOwnershipKernelComponent,
...
impl KernelComponents {
    pub fn bootstrap(config: &DaemonBootstrapConfig) -> KernelResult<Self> {
        ...
        Ok(Self {
            ...
            runtime_ownership: RuntimeOwnershipKernelComponent::new(),
    ...
    pub fn runtime_ownership(&self) -> &RuntimeOwnershipKernelComponent {
